...
rsync -aAXvz --delete-missing-args --delete /etc/nixos /mnt/b/homebackup
rsync -aAXvz --delete-missing-args --delete --exclude=/mgr/.cache /home/mgr /mnt/b/nixconfigbackup
