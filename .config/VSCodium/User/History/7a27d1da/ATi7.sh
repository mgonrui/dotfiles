...
rsync -aAXvz --delete-missing-args --delete /etc/nixos /mnt/b/home_backup
rsync -aAXvz --delete-missing-args --delete --exclude=/mgr/.cache /home/mgr /mnt/b/nixconfig_backup
