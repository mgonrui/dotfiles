...
Key([mod, "control"], "equal", lazy.spawn("light -A 5")),
Key([mod, "control"], "minus", lazy.spawn("light -U 5")),
...
screens = [
    # vga monitor
    Screen(
        wallpaper="~/media/images/desktop_wallpapers/gruvbox-light/chinese-hills1.jpg",
        wallpaper_mode="fill",
        top=bar.Bar(
            [
                widget.GroupBox(
