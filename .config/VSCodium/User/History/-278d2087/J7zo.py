...
groups = [
    ...
    # browser
    Group("b",label=" 󰖟  ", matches=[Match(wm_class="firefox" "librewolf" "brave-browser" "Tor Browser" )],layout=default_layout),
    # ide
    ...
    # downloads 
    Group("d", label="   ", matches=[Match(wm_class="qbittorrent" "amule" )], layout=default_layout),
    # misc
