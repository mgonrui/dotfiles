...
Key([mod], "r",lazy.spawn("xterm -class float -geometry 80x40 -e sh .scripts/menu/menu.sh")),
...
groups = [
    ScratchPad("scratchpad",[
        ...
        DropDown("clipgrab","clipgrab",x=0.5,y=0.6,width=0.5,height=0.5,opacity=1,on_focus_lost_hide=False,),
    ],),
    # calendar
    # Group("s", label="   ", matches=[Match(wm_class="chromium-browser")], layout=default_layout),

    # browser
    Group("w",label=" 󰖟  ", matches=[Match(wm_class="firefox" "librewolf" "brave-browser" "Tor Browser" )],layout=default_layout),
    # ide
    Group("i", label="   ", matches=[Match(wm_class="vscodium" "DrRacket" "emacs" "ghidra-Ghidra")], layout=default_layout),
    # notes 
    ...
    # email & chat
    Group("e", label="   ", matches=[Match(wm_class= "tutanota-desktop" "thunderbird" "hexchat" "signal" "net.sourceforge.liferea" )], layout=default_layout),
    # password manager
...
screens = [
    # vga monitor
    Screen(
        #wallpaper="~/media/images/desktop_wallpapers/gruvbox/202020.png",
        wallpaper="~/media/images/desktop_wallpapers/gruvbox/pixels1.png",
        wallpaper_mode="fill",
        top=bar.Bar(
            [
                widget.GroupBox(
    ...
    Screen(
        ...
        wallpaper="~/media/images/desktop_wallpapers/gruvbox/pixels1_4:3.png",
        #wallpaper="~/media/images/desktop_wallpapers/gruvbox/202020.png",
        wallpaper_mode="fill",
        top=bar.Bar(
            [
