...
groups = [
    ...
    # N
    Group("0", label="NOT", matches=[Match(wm_class="obsidian")], layout="monadtall"),
    # C
    Group("5", label="CAL", matches=[Match(wm_class="chromium-browser")], layout="monadtall"),
    # W
    Group("9",label="WEB",matches=[Match(wm_class="firefox" "brave-browser")],layout="max"),
    # I
    Group("8", label="IDE", matches=[Match(wm_class="code" "kitty" "emacs")], layout="monadtall"),
    # F
    Group("7", label="FIL", matches=[Match(wm_class="nemo" "dolphin" "calibre")], layout="monadtall"),
    # P
    Group("6", label="PSW", matches=[Match(wm_class="keepassxc")], layout="monadtall"),
    # M
    Group("4",label="MUS",matches=[Match(wm_class="spotify" "easyeffects")], layout="monadtall"),
    Group("2", label="VMS", matches=[Match(wm_class="virt-manager")], layout="monadtall"),
    # T
    Group("1", label="TRR", matches=[Match(wm_class="qbittorrent")], layout="monadtall"),
]
...
layouts = [
    ...
    # layout.TreeTab(**layout_theme), # interesting layout
