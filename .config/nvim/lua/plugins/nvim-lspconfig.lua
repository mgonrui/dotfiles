return {
  ...
  config = function()
    vim.api.nvim_create_autocmd('LspAttach', {
      ...
      callback = function(event) -- function that lets us more easily define mappings specificfor LSP related items.
        local map = function(keys, func, desc, mode)
          mode = mode or 'n'
          vim.keymap.set(mode, keys, func, { buffer = event.buf, desc = 'LSP: ' .. desc })
        end

        map('gm', vim.lsp.buf.rename, '[g]oto [m]odify name')
        ...
        map('gw', require('snacks.picker').lsp_workspace_symbols, '[g]oto [w]orkspace symbols')
